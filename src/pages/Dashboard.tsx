  ...
  return (
    <MainLayout>
      <div className="max-w-5xl mx-auto">
        ...
        {/* Chat with Ollie link */}
        <div className="mb-6 text-center">
          <Link 
            to="/chat" 
            className="inline-flex items-center gap-2 bg-omni-mint hover:bg-omni-mint/90 text-black px-6 py-3 rounded-full transition-all"
          >
            <OllieAvatar size="sm" />
            <span className="font-medium">Chat with Ollie</span>
